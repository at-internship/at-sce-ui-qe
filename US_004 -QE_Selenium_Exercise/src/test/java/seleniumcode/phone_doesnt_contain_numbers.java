...
public class phone_doesnt_contain_numbers {

        private ChromeDriver driver = Hooks.getDriver();

        @When("^Error Message when phone doesnt contain numbers$")
        public void error_Message_when_phone_doesnt_contain_numbers() throws Throwable {
            ...
            Thread.sleep(1000);
            // phone
            driver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[4]/div/input")).sendKeys("adasdasd");
            // Gender
