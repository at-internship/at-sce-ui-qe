...
public class The_skills_is_not_selected {


    private ChromeDriver driver = Hooks.getDriver();

    @When("^The skills is not selected$")
    public void The_skills_is_not_selected() throws Throwable {
        // FullName
        ...
        Thread.sleep(1000);
        // Address
        driver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[2]/div/textarea")).sendKeys("nuevo leon 179");
        // Email address
        ...
        driver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[7]/div/multi-select/div[2]/ul/li[20]/a")).click();
        Thread.sleep(1000);
        // skill
