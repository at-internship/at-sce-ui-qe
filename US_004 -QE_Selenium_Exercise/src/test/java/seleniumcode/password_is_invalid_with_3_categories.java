...
public class password_is_invalid_with_3_categories {

    private ChromeDriver driver = Hooks.getDriver();

    @When("^Error message when the password is invalid with 3 categories$")
    public void Error_message_when_the_password_is_invalid_with_3_categories() throws Throwable {
        // FullName
        ...
        Thread.sleep(1000);
        // password
        driver.findElement(By.xpath("//*[@id=\"firstpassword\"]")).sendKeys("123");
        // confirm password
        driver.findElement(By.xpath("//*[@id=\"secondpassword\"]")).sendKeys("123");
        Thread.sleep(1000);
        // photo
