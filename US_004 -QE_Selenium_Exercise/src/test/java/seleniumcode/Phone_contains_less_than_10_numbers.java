...
public class Phone_contains_less_than_10_numbers {

    private ChromeDriver driver = Hooks.getDriver();

    @When("^Error Message when phone contains less than 10 numbers$")
    public void Error_message_when_phone_contains_less_than_10_numbers() throws Throwable {
        // FullName
        ...
        Thread.sleep(1000);
        // phone
        driver.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[4]/div/input")).sendKeys("123456789");
        // Gender
