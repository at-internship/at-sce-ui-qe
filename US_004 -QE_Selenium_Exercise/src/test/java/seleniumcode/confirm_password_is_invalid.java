...
public class confirm_password_is_invalid {

    private ChromeDriver driver = Hooks.getDriver();

    @When("^Error Message when confirm password is invalid$")
    public void Error_message_when_confirm_password_is_invalid() throws Throwable {
        // FullName
        ...
        Thread.sleep(1000);
        // password
        driver.findElement(By.xpath("//*[@id=\"firstpassword\"]")).sendKeys("G4_to1");
        // confirm password
        driver.findElement(By.xpath("//*[@id=\"secondpassword\"]")).sendKeys("G4_to2");
        Thread.sleep(1000);
        // photo
